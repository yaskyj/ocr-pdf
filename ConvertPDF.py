...
file_list = []
search_words = ['adult', 'airfare', 'alcoh', 'alcohol', 'apparel', 'bail', 'beer', 'campaign', 'candidat', 'cantina', 'capital', 'casino', 'celebra', 'chair', 'church', 'cigar', 'clinic', 'cloth', 'club', 'college', 'comput', 'contribu', 'court', 'credit', 'danc', 'dentist', 'dinero', 'dinner', 'doctor', 'donation', 'entertain', 'escort', 'exotic', 'favor', 'festiv', 'fiest', 'fine', 'flower', 'gambl', 'game', 'gaming', 'gift', 'govern', 'home', 'hospit', 'hotel', 'hotline', 'hous', 'jail', 'jewel', 'lawyer', 'liqu', 'liquor', 'lunch', 'luxur', 'membership', 'monitor', 'museum', 'music', 'party', 'poker', 'polic', 'politic', 'recreation', 'recruit', 'representa', 'restaur', 'reward', 'school', 'server', 'social', 'sport', 'taver', 'tele', 'theater', 'theatre', 'university', 'vacati', 'visa', 'welfare', 'wine', 'intern']
count = 0
